      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Section title="Source">
          <textarea
            ...
            spellCheck={false}
            className="min-h-[420px] w-full resize-y rounded-xl border border-input bg-card px-3.5 py-2.5 font-mono text-[13px] leading-relaxed outline-none transition-colors hover:border-foreground/40 focus-visible:border-primary focus-visible:ring-[3px] focus-visible:ring-ring/40"
          />
